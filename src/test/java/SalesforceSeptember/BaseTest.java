		...
		public static void SelectfromDropDown (WebElement ele, String text) {
		 ...
		 select.selectByVisibleText(text);
		  ...
		  public static void switchFrame(WebElement ele, String ObjectName) {
              ...
              public static void selectCheckBox(WebElement ele, String objectName) {
          		
          		if(ele.isDisplayed()) {
          			
          			if(ele.isSelected()) {
          				System.out.println("Pass: "+objectName+" is already selected");

          			}else{
          				ele.click();
          			System.out.println("Pass: "+objectName+" is selected");
          		    }}
          			else {
          			System.out.println("Fail:"+objectName+" is not present.Please chk application");	
